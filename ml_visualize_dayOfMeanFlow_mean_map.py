...
plt.hist(df["dayOfMeanFlow_mean"])
plt.show()
...
plt.xlabel("maen annual precipitation")
plt.ylabel("mean annual temperature")
plt.title("Day of Mean Flow across Spatial Features")
plt.show()


plt.scatter(gords, temps, color=ncolors, alpha=0.7)
...
cb1.set_label("day of mean flow")
plt.show()
